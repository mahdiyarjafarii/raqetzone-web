export function getVideoPrice({ model, duration, resolution }) {
  ...
  if(process.env.IS_DEV) console.log({ normalizedKey })
  const priceTable = {
    // Ltxs - $0.05 per second = 25 credits for 4 seconds
    ...
    // Kling 2.5 Turbo Pro - $0.07 per second = 30 credits for 4 seconds
