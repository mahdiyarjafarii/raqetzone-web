...
const demos = [
  {
    name: "زمین پادل آزادی",
    location: "تهران، آزادی",
    address: "خیابان آزادی، کوچه ورزشگاه، پلاک ۱۲",
    surfaceType: "artificial",
    sportType: "padel",
    pricePerHour: 350000,
    description: "زمین پادل با کیفیت بالا و روشنایی عالی برای بازی شبانه",
    openTime: "08:00",
    closeTime: "23:00",
    slotDuration: 60,
  },
  ...
  {
    name: "زمین پادل اکباتان",
    location: "تهران، اکباتان",
    address: "فاز ۳ اکباتان، مجموعه ورزشی مهتاب",
    surfaceType: "artificial",
    sportType: "padel",
    pricePerHour: 280000,
    description: "زمین پادل سرپوشیده با تهویه مناسب، ایده‌آل برای فصل سرد",
    openTime: "09:00",
    closeTime: "23:00",
    slotDuration: 90,
  },
  ...
  {
    name: "زمین پادل نیاوران",
    location: "تهران، نیاوران",
    address: "خیابان نیاوران، پارک جمشیدیه",
    surfaceType: "artificial",
    sportType: "padel",
    pricePerHour: 400000,
    description: "زمین پادل لوکس در محیطی سرسبز با امکانات کامل",
    openTime: "08:00",
    closeTime: "22:00",
    slotDuration: 60,
  },
